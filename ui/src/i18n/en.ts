export const enDict: Record<string, string> = {
  ...
  "Knowledge base searched": "Knowledge base searched",
  ...
  "Retry": "Retry",
  "The answer could not be verified against its cited sources. Please try again.": "The answer could not be verified against its cited sources. Please try again.",
  "The knowledge base search could not be completed. Please try again.": "The knowledge base search could not be completed. Please try again.",
  "The answer's source check could not be completed. Please try again.": "The answer's source check could not be completed. Please try again.",
  "Action interrupted": "Action interrupted",
  "Failed actions: {count}": "Failed actions: {count}",
  "--- Select ---": "--- Select ---",
  Accept: "Accept",
  ...
  "Answers from {name} are generated by AI and may contain mistakes. Check important information.":
    "Answers from {name} are generated by AI and may contain mistakes. Check important information.",
  "A response is still running. Wait for it to finish or cancel it.": "A response is still running. Wait for it to finish or cancel it.",
  Arabic: "Arabic",
  "Are you sure you want to reset the conversation?":
    "Are you sure you want to reset the conversation?",
  "As-Is": "As-Is",
  "as-is": "as-is",
  "Ask anything…": "Ask a question…",
  "Ask me": "Ask",
  Assistant: "Assistant",
  ...
  Spanish: "Spanish",
  Stop: "Stop",
  "Sites searched: {count}": "Sites searched: {count}",
  ...
  "Knowledge Base searches: {count}": "Knowledge Base searches: {count}",
  "Websites searched: {count}": "Websites searched: {count}",
  "Other tools used: {count}": "Other tools used: {count}",
  "Thinking…": "Thinking…",
  "Working...": "Working…",
