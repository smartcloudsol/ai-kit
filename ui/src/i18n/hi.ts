export const hiDict: Record<string, string> = {
  "{name} is thinking…": "{name} सोच रहा है…",
  "Sending request…": "अनुरोध भेजा जा रहा है…",
  "Waiting for reply…": "उत्तर की प्रतीक्षा है…",
  "Reconnecting…": "फिर से कनेक्ट हो रहा है…",
  "Checking sources…": "स्रोतों की जाँच जारी है…",
  "Knowledge base searched": "ज्ञान आधार की खोज पूरी हुई",
  "Web search completed": "वेब खोज पूरी हुई",
  "Calculation completed": "गणना पूरी हुई",
  "Script completed": "स्क्रिप्ट पूरी हुई",
  "Check completed": "जाँच पूरी हुई",
  "Action completed": "कार्रवाई पूरी हुई",
  "Action failed": "कार्रवाई विफल हुई",
  "Search query: {query}": "खोज क्वेरी: {query}",
  "Categories: {count}": "श्रेणियाँ: {count}",
  "Subcategories: {count}": "उपश्रेणियाँ: {count}",
  "Tags: {count}": "टैग: {count}",
  "Results: {count}": "परिणाम: {count}",
  "Retry": "फिर से प्रयास करें",
  "The answer could not be verified against its cited sources. Please try again.": "उद्धृत स्रोतों के आधार पर उत्तर की पुष्टि नहीं हो सकी। कृपया फिर से प्रयास करें।",
  "The knowledge base search could not be completed. Please try again.": "ज्ञान आधार में खोज पूरी नहीं हो सकी। कृपया फिर से प्रयास करें।",
  "The answer's source check could not be completed. Please try again.": "उत्तर के स्रोतों की जाँच पूरी नहीं हो सकी। कृपया फिर से प्रयास करें।",
  "Action interrupted": "कार्रवाई बाधित हुई",
  "Failed actions: {count}": "विफल कार्रवाइयाँ: {count}",
  "--- Select ---": "--- चुनें ---",
  "A response is still running. Wait for it to finish or cancel it.": "जवाब अभी तैयार हो रहा है। इसके पूरा होने की प्रतीक्षा करें या इसे रद्द करें।",
  Accept: "स्वीकार करें",
  ...
  "Answers from {name} are generated by AI and may contain mistakes. Check important information.":
    "{name} के उत्तर AI द्वारा तैयार किए जाते हैं और उनमें गलतियाँ हो सकती हैं। महत्वपूर्ण जानकारी की जाँच करें।",
  "I couldn't find enough reliable information to answer that. Please rephrase the question or narrow the topic.":
    "मुझे उत्तर देने के लिए पर्याप्त विश्वसनीय जानकारी नहीं मिली। कृपया प्रश्न को नए शब्दों में पूछें या विषय को सीमित करें।",
  "The AI response took too long. Please try again.":
    "AI के उत्तर में बहुत अधिक समय लगा। कृपया फिर से प्रयास करें।",
  Arabic: "अरबी",
  ...
  "Response stopped.": "जवाब रोक दिया गया।",
  Reset: "रीसेट करें",
  ...
  shorter: "कम",
  Show: "दिखाओ",
  "Sites searched: {count}": "खोजी गई साइटें: {count}",
  "Something went wrong.": "कुछ गलत हो गया।",
  "Something went wrong. Please try again.": "कुछ गलत हो गया। कृपया पुनः प्रयास करें।",
  "We couldn't verify that you're human. Please try again.": "हम यह सत्यापित नहीं कर पाए कि आप इंसान हैं। कृपया पुनः प्रयास करें।",
  "You are not authorized to use this AI feature. Please sign in or contact the site owner.": "आपको इस AI फीचर का उपयोग करने की अनुमति नहीं है। कृपया साइन इन करें या साइट स्वामी से संपर्क करें।",
  "Too many requests. Please wait a moment and try again.": "बहुत अधिक अनुरोध। कृपया एक क्षण प्रतीक्षा करके पुनः प्रयास करें।",
  "The request could not be processed. Review your input and try again.": "अनुरोध संसाधित नहीं किया जा सका। अपनी प्रविष्टि की समीक्षा करें और पुनः प्रयास करें।",
  "We couldn't reach the AI service. Check your connection and try again.": "AI सेवा तक पहुंच नहीं हो पाई। अपने कनेक्शन की जांच करें और पुनः प्रयास करें।",
  "The AI service is temporarily unavailable. Please try again.": "AI सेवा अस्थायी रूप से उपलब्ध नहीं है। कृपया पुनः प्रयास करें।",
  ...
  "The configured AI model does not support image attachments. Contact the site administrator.":
    "कॉन्फ़िगर किया गया AI मॉडल छवि अटैचमेंट का समर्थन नहीं करता। साइट व्यवस्थापक से संपर्क करें।",
  ...
  "This summary was generated by AI and may contain mistakes. Check important information.":
    "यह सारांश AI द्वारा तैयार किया गया है और इसमें गलतियाँ हो सकती हैं। महत्वपूर्ण जानकारी की जाँच करें।",
  Title: "शीर्षक",
  "TL;DR": "संक्षेप में",
  tldr: "संक्षेप में",
  Tone: "स्वर",
  ...
  "{name} is working…": "{name} काम कर रहा है…",
  "Generating response…": "उत्तर तैयार हो रहा है…",
  "Knowledge Base searches: {count}": "ज्ञानकोष में खोजें: {count}",
  "Websites searched: {count}": "खोजी गई वेबसाइटें: {count}",
  "Other tools used: {count}": "उपयोग किए गए अन्य टूल: {count}",
  "Working...": "काम हो रहा है…",
