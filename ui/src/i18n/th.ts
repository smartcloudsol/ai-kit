export const thDict: Record<string, string> = {
  "{name} is thinking…": "{name} กำลังคิด…",
  "Sending request…": "กำลังส่งคำขอ…",
  "Waiting for reply…": "กำลังรอคำตอบ…",
  "Reconnecting…": "กำลังเชื่อมต่อใหม่…",
  "Checking sources…": "กำลังตรวจสอบแหล่งข้อมูล…",
  "Knowledge base searched": "ค้นหาฐานความรู้เสร็จแล้ว",
  "Web search completed": "ค้นหาเว็บเสร็จแล้ว",
  "Calculation completed": "คำนวณเสร็จแล้ว",
  "Script completed": "เรียกใช้สคริปต์เสร็จแล้ว",
  "Check completed": "ตรวจสอบเสร็จแล้ว",
  "Action completed": "ดำเนินการเสร็จแล้ว",
  "Action failed": "ดำเนินการไม่สำเร็จ",
  "Search query: {query}": "คำค้นหา: {query}",
  "Categories: {count}": "หมวดหมู่: {count}",
  "Subcategories: {count}": "หมวดหมู่ย่อย: {count}",
  "Tags: {count}": "แท็ก: {count}",
  "Results: {count}": "ผลลัพธ์: {count}",
  "Retry": "ลองอีกครั้ง",
  "The answer could not be verified against its cited sources. Please try again.": "ไม่สามารถตรวจสอบคำตอบกับแหล่งข้อมูลที่อ้างอิงได้ โปรดลองอีกครั้ง",
  "The knowledge base search could not be completed. Please try again.": "ไม่สามารถค้นหาฐานความรู้จนเสร็จได้ โปรดลองอีกครั้ง",
  "The answer's source check could not be completed. Please try again.": "ไม่สามารถตรวจสอบแหล่งข้อมูลของคำตอบจนเสร็จได้ โปรดลองอีกครั้ง",
  "Action interrupted": "การดำเนินการถูกขัดจังหวะ",
  "Failed actions: {count}": "การดำเนินการที่ไม่สำเร็จ: {count}",
  "--- Select ---": "--- เลือก ---",
  "A response is still running. Wait for it to finish or cancel it.": "คำตอบยังอยู่ระหว่างการสร้าง โปรดรอจนเสร็จหรือยกเลิก",
  Accept: "ยอมรับ",
  ...
  "Answers from {name} are generated by AI and may contain mistakes. Check important information.":
    "คำตอบจาก {name} สร้างโดย AI และอาจมีข้อผิดพลาด โปรดตรวจสอบข้อมูลสำคัญ",
  "I couldn't find enough reliable information to answer that. Please rephrase the question or narrow the topic.":
    "ไม่พบข้อมูลที่เชื่อถือได้เพียงพอสำหรับตอบคำถามนี้ โปรดปรับถ้อยคำของคำถามหรือระบุหัวข้อให้แคบลง",
  "The AI response took too long. Please try again.":
    "AI ใช้เวลาตอบนานเกินไป โปรดลองอีกครั้ง",
  Arabic: "ภาษาอาหรับ",
  ...
  "Response stopped.": "หยุดการตอบแล้ว",
  Reset: "รีเซ็ต",
  ...
  "Running a script…": "กำลังเรียกใช้สคริปต์…",
  ...
  "Searching knowledge base…": "กำลังค้นหาในฐานความรู้…",
  ...
  shorter: "สั้นกว่า",
  Show: "แสดง",
  "Sites searched: {count}": "เว็บไซต์ที่ค้นหา: {count}",
  "Something went wrong.": "เกิดข้อผิดพลาดบางอย่างขึ้น",
  "Something went wrong. Please try again.": "เกิดข้อผิดพลาดบางอย่าง ลองอีกครั้ง",
  "We couldn't verify that you're human. Please try again.": "เราไม่สามารถยืนยันได้ว่าคุณเป็นมนุษย์ กรุณาลองอีกครั้ง",
  "You are not authorized to use this AI feature. Please sign in or contact the site owner.": "คุณไม่มีสิทธิ์ใช้งานคุณลักษณะ AI นี้ กรุณาเข้าสู่ระบบหรือติดต่อเจ้าของเว็บไซต์",
  "Too many requests. Please wait a moment and try again.": "มีการขอเข้าถึงมากเกินไป กรุณารอสักครู่แล้วลองอีกครั้ง",
  "The request could not be processed. Review your input and try again.": "ไม่สามารถประมวลผลคำขอได้ โปรดตรวจสอบข้อมูลของคุณและลองอีกครั้ง",
  "We couldn't reach the AI service. Check your connection and try again.": "ไม่สามารถเข้าถึงบริการ AI ได้ ตรวจสอบการเชื่อมต่อและลองอีกครั้ง",
  "The AI service is temporarily unavailable. Please try again.": "บริการ AI ไม่พร้อมใช้งานชั่วคราว กรุณาลองอีกครั้ง",
  "Request ID": "รหัสคำขอ",
  Sources: "แหล่งที่มา",
  Spanish: "ภาษาสเปน",
  Stop: "หยุด",
  ...
  "The configured AI model does not support image attachments. Contact the site administrator.":
    "โมเดล AI ที่กำหนดค่าไว้ไม่รองรับไฟล์แนบรูปภาพ โปรดติดต่อผู้ดูแลเว็บไซต์",
  ...
  "This summary was generated by AI and may contain mistakes. Check important information.":
    "ข้อมูลสรุปนี้สร้างโดย AI และอาจมีข้อผิดพลาด โปรดตรวจสอบข้อมูลสำคัญ",
  Title: "ชื่อ",
  "TL;DR": "สรุปสั้นๆ",
  tldr: "สรุปสั้นๆ",
  Tone: "โทน",
  ...
  Translating: "การแปล",
  "Translating text": "กำลังแปลข้อความ",
  ...
  Why: "ทำไม",
  "Working…": "กำลังทำงาน…",
  "{name} is working…": "{name} กำลังทำงาน…",
  "Generating response…": "กำลังสร้างคำตอบ…",
  "Knowledge Base searches: {count}": "จำนวนครั้งที่ค้นฐานความรู้: {count}",
  "Websites searched: {count}": "เว็บไซต์ที่ค้นหา: {count}",
  "Other tools used: {count}": "เครื่องมืออื่นที่ใช้: {count}",
  "Working...": "กำลังทำงาน…",
