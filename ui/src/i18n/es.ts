export const esDict: Record<string, string> = {
  ...
  "Answers from {name} are generated by AI and may contain mistakes. Check important information.":
    "Las respuestas de {name} son generadas por IA y pueden contener errores. Verifica la información importante.",
  Arabic: "árabe",
  ...
  "We couldn't verify that you're human. Please try again.": "No pudimos verificar que seas humano. Inténtalo de nuevo.",
  "You are not authorized to use this AI feature. Please sign in or contact the site owner.": "No tienes autorización para usar esta función de IA. Inicia sesión o contacta al propietario del sitio.",
  "Too many requests. Please wait a moment and try again.": "Demasiadas solicitudes. Espera un momento y vuelve a intentarlo.",
  "The request could not be processed. Review your input and try again.": "No se pudo procesar la solicitud. Revisa tu entrada e inténtalo de nuevo.",
  "We couldn't reach the AI service. Check your connection and try again.": "No pudimos conectarnos con el servicio de IA. Revisa tu conexión e inténtalo de nuevo.",
  "The AI service is temporarily unavailable. Please try again.": "El servicio de IA no está disponible temporalmente. Inténtalo de nuevo.",
  ...
  "The configured AI model does not support image attachments. Contact the site administrator.":
    "El modelo de IA configurado no admite archivos adjuntos de imagen. Contacta con el administrador del sitio.",
  ...
  "This summary was generated by AI and may contain mistakes. Check important information.":
    "Este resumen fue generado por IA y puede contener errores. Verifica la información importante.",
  Title: "Título",
  "TL;DR": "Resumen",
  tldr: "Resumen",
  Tone: "Tono",
