export const deDict: Record<string, string> = {
  ...
  "We couldn't verify that you're human. Please try again.": "Wir konnten nicht verifizieren, dass du ein Mensch bist. Bitte versuche es erneut.",
  "You are not authorized to use this AI feature. Please sign in or contact the site owner.": "Du bist nicht berechtigt, diese KI-Funktion zu nutzen. Bitte melde dich an oder kontaktiere den Website-Besitzer.",
  "Too many requests. Please wait a moment and try again.": "Zu viele Anfragen. Bitte warte einen Moment und versuche es erneut.",
  "The request could not be processed. Review your input and try again.": "Die Anfrage konnte nicht verarbeitet werden. Überprüfe deine Eingabe und versuche es erneut.",
  "We couldn't reach the AI service. Check your connection and try again.": "Wir konnten den KI-Dienst nicht erreichen. Überprüfe deine Verbindung und versuche es erneut.",
  "The AI service is temporarily unavailable. Please try again.": "Der KI-Dienst ist vorübergehend nicht verfügbar. Bitte versuche es erneut.",
