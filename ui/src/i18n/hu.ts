export const huDict: Record<string, string> = {
  ...
  "Answers from {name} are generated by AI and may contain mistakes. Check important information.":
    "A {name} válaszait mesterséges intelligencia állítja elő, ezért hibákat tartalmazhatnak. Ellenőrizd a fontos információkat.",
  Arabic: "arab",
  ...
  "The configured AI model does not support image attachments. Contact the site administrator.":
    "A beállított AI-modell nem támogatja a képek csatolását. Fordulj a webhely adminisztrátorához.",
  ...
  "This summary was generated by AI and may contain mistakes. Check important information.":
    "Ezt az összefoglalót mesterséges intelligencia állította össze, ezért hibákat tartalmazhat. Ellenőrizd a fontos információkat.",
  Title: "Cím",
  "TL;DR": "TL;DR",
  tldr: "tldr",
  Tone: "Hangnem",
